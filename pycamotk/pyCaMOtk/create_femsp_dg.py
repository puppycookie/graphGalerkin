...
class create_femsp_dg(object):
	...
	def __init__(self,prob,msh,ptest,ptrial):
		...
		self.ldof2gdof_eqn=create_ldof2gdof_dg(self.neqn,self.nv_eqn,self.nelem,msh.e2vcg)
		self.ldof2gdof_var=create_ldof2gdof_dg(self.nvar,self.nv_var,self.nelem,msh.e2vcg)
